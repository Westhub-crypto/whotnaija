      ...
      <div className="main-content">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} style={{ padding: '20px 16px', paddingBottom: 100 }}>
          ...
          {!hasDeposited && (
            ...
            >
              <div>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#fff', marginBottom: 4 }}>💳 Unlock Withdrawals</div>
                <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>Deposit min ₦1,000 to enable withdrawals & grow your balance</div>
              </div>
